...
import io.digitalis.cassandra.probe.actions.FatalProbeException;
import io.digitalis.cassandra.probe.actions.IsReachableProbe;
import io.digitalis.cassandra.probe.actions.ProbeAction;
import io.digitalis.cassandra.probe.actions.TestCQLQueryProbe;
...
import io.digitalis.cassandra.probe.actions.SocketProbe;
...
public class Prober {
	...
	public Prober(int storagePort, int nativePort, int thriftPort, String[] contactPoints, String yamlPath, String userName, String password, boolean nativeProbe, boolean thriftProbe,
			boolean storageProbe, boolean pingProbe, String testCql, ConsistencyLevel consistency, boolean tracingEnabled) {
